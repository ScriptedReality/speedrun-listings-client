...
export const GlareCard = ({
  ...
  const containerStyle = {
    ...
    //another legendary use of the typescript any
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[1500px] [aspect-ratio:225/21]"
      ref={refElement}
      onPointerMove={(event) => {
